...
from deps import get_checkin_repo, get_checkin_service, get_current_user_id
...
async def create_readiness(
    ...
    return await svc.create_readiness(repo, user_id, payload)
...
async def get_readiness(
    ...
    result = await svc.get_readiness(repo, user_id, entry_date)
    if not result:
...
async def create_reflection(
    ...
    return await svc.create_reflection(repo, user_id, payload)
...
async def get_reflection(
    ...
    result = await svc.get_reflection(repo, user_id, entry_date)
    if not result:
...
async def upsert_journal(
    ...
    return await svc.upsert_journal(repo, user_id, payload)
...
async def get_journal(
    ...
    result = await svc.get_journal(repo, user_id, entry_date)
    if not result:
...
async def get_history(
    ...
    return await svc.get_history(repo, user_id, days)