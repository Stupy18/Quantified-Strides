...
from deps import get_current_user_id, get_strength_repo
...
async def list_garmin_sessions(
    ...
    return await _svc.list_garmin_sessions(repo, user_id, days)
...
async def list_sessions(
    ...
    return await _svc.list_sessions(repo, user_id, days)
...
async def create_session(
    ...
    return await _svc.create_session(repo, user_id, payload)
...
async def get_session_detail(
    ...
    result = await _svc.get_session_detail(repo, user_id, session_id)
    if not result:
...
async def get_1rm_history(
    ...
    return await _svc.get_1rm_history(repo, user_id, exercise, days)
...
async def get_tracked_exercises(
    ...
    return await _svc.get_tracked_exercises(repo, user_id)
...
async def list_exercises(
    ...
    return await _svc.list_exercises(repo, search)
...
async def create_exercise(
    ...
    return await _svc.create_exercise(repo, payload)